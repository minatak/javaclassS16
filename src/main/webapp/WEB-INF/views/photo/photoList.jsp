...
<div class="container">
  <table class="table table-borderless">
    ...
    <tr>
      ...
      <td class="text-right">
        <input type="button" value="사진올리기" onclick="location.href='${ctp}/photo/photoInput';" class="btn btn-success"/>
        <input type="button" value="한장씩보기" onclick="location.href='${ctp}/photo/photoSingle';" class="btn btn-info mr-2"/>
      </td>
    </tr>
  </table>
	    ...
	    <div class="card mb-5" style="width:220px;">
		    <div class="card-body m-0 p-2 text-center">
		      <a href="${ctp}/photo/photoContent?idx=${vo.idx}">
		        <img src="${ctp}/thumbnail/${vo.thumbnail}" width="200px" height="150px" title="${vo.title}" class="m-0" />
		      </a>
		    </div> 
