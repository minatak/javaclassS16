...
<div class="inputContainer">
  <div class="header">
    ...
    <font size="5" class="mb-4 h2">공지사항 수정</font>
  </div>
  <form name="myform" method="post">
    ...
    <div class="form-group">
      ...
      <div class="radio-inline">
        <input type="radio" name="pinned" id="pinnedTrue" value="true" ${vo.pinned ? 'checked' : ''} />
        <label for="isPinnedTrue">고정</label>
        <input type="radio" name="pinned" id="pinnedFalse" value="false" ${!vo.pinned ? 'checked' : ''} />
    ...
    <div class="form-group">
      <label>중요도</label>
      <div class="radio-inline">
        <input type="radio" name="important" id="importantTrue" value="true" ${vo.important ? 'checked' : ''} />
        <label for="important">중요</label>
        <input type="radio" name="important" id="importantFalse" value="false" ${!vo.important ? 'checked' : ''} />
    ...
    <div class="form-group">
      <input type="button" value="돌아가기" onclick="location.href='${ctp}/notice/noticeView?idx=${vo.idx}';" class="btn btn-back"/>
    </div>
