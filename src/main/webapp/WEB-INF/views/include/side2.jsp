...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left sidebar" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-container text-center">
    ...
    <!-- 
    <button class="btn btn-outline-secondary" type="button" data-toggle="modal" data-target="#titleModal">
		  <c:if test="${!empty sRelationship}">
			  호칭: <span id="currentTitle">${sRelationship}</span>
		  </c:if>
		  <c:if test="${empty sRelationship}">
			  호칭: <span id="currentTitle">호칭 설정하기</span>
		  </c:if>
		</button>
		 -->
  ...
  <div class="w3-bar-block mt-5 ml-2">
    <a href="${ctp}/" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-home fa-fw w3-margin-right"></i>홈</a>
    ...
    <a href="${ctp}/vote/voteList" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-poll fa-fw w3-margin-right"></i>가족투표</a>
    <a href="${ctp}/familyMeeting/meetingList" onclick="w3_close()" class="w3-bar-item w3-button w3-padding"><i class="fa fa-solid fa-users-line fa-fw w3-margin-right"></i>가족회의</a>
